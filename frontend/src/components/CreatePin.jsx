...
const CreatePin = ({ user }) => {
  ...
  const uploadImage = (e) => {
    ...
    const { type, name } = e.target.files[0]; // destructuring
    if (
      type === "image/png" ||
      type === "image/svg" ||
      type === "image/gif" ||
          ...
          <div className="flex flex-col ">
            <div>
              ...
              <select
                ...
                className="outline-none w-4/5 text-base border-b-2 border-gray-200 p-2 rounded-md cursor-poinnter"
              >
