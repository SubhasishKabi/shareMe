...
//the pinId is passed as props(various levels) from feed component
  ...
  const fetchPinDetails = () => {
    ...
    if (query) {
      client.fetch(query).then((data) => {
        // console.log(data);
        //an array and inside it is an object containing the details
        setPinDetail(data[0]);
      ...
      >
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          ...
          <div className="flex flex-wrap mt-6 gap-3 ">
            ...
            <input
              className="flex-1 border-gray-300 outline-none border-2 p-2 rounded-2xl focus:border-gray-600"
              type="text"
