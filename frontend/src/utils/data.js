...
// * means it will start matching the terms even before you finish the term
//The asset -> {url} clause in the query means that the query will return the URL of the asset field for each
//document that matches the query. The URL of the asset field is the URL that can be used to access the binary data
//stored in the asset field.
// the asset keyword refers to the asset field in a Sanity document
...
//this query is used to get all the pins of the category as of the above pin fetched(but not that pin which is fetched).
